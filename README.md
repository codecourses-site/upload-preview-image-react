...
- For the full course, You can refer to this [link](https://codecourses.site/react/how-to-upload-and-preview-image-in-react/).

- You can refer to this [Youtube video](https://www.youtube.com/watch?v=vB9h5AKmgJk) for the live demo.
...
Questions about running the demo? [Open an issue](https://github.com/codecourses-site/upload-preview-image-react/issues). We're here to help ✌️
